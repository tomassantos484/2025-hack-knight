...
const SignIn = () => {
  ...
  useEffect(() => {
    console.log('Auth state in SignIn:', { isSignedIn });
  }, [isSignedIn]);
      ...
      <section className="py-8 min-h-[calc(100vh-80px)] flex items-center justify-center">
        ...
        >
          <div className="text-center mb-4">
            ...
            <p className="text-eco-dark/70">Sign in to continue your eco journey</p>
          </div>
          ...
          {/* Custom sign up link for smoother navigation */}
